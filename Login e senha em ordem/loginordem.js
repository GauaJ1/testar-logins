...
// O usuário deve preencher essas listas!
// **IMPORTANTE:** O script tenta as combinações em ordem. O primeiro usuário da lista será tentado com a primeira senha, o segundo usuário com a segunda senha, e assim por diante.
const usuarios = [
